      ...
      {open ? (
        ...
        >
          <div
            ...
            aria-hidden
          />
          <div className="relative z-10 flex max-h-[min(90dvh,720px)] w-full max-w-lg flex-col overflow-y-auto rounded-2xl border border-gold/25 bg-[#0a0a0a] p-5 shadow-2xl shadow-black/50 sm:p-7">
